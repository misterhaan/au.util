namespace au.util.comctl {
  partial class CaptionedPictureBox {
    ...
    private void InitializeComponent() {
      ...
      this._lblCaption.Click += new System.EventHandler(this.subControl_Click);
      this._lblCaption.DoubleClick += new System.EventHandler(this.subControl_DoubleClick);
      // 
      // _pb
      // 
      ...
      this._pb.Click += new System.EventHandler(this.subControl_Click);
      this._pb.DoubleClick += new System.EventHandler(this.subControl_DoubleClick);
      // 
      // CaptionedPictureBox
      // 
